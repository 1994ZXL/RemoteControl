...
/**
 * Created by ZXL on 2016/3/16.
 */
public class RemotControlFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        Button zeroButtom = (Button)bottomRow.getChildAt(1);
        zeroButtom.setText("0");
        zeroButtom.setOnClickListener(numberButtonListener);
